    ...
    return ClipRRect(
      child: BackdropFilter(
        ...
        child: Container(
          width: 280,
          decoration: BoxDecoration(
            color: AppTheme.drawerSurface.withValues(alpha: 0.85),
            border: Border(
              right: BorderSide(
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  AppTheme.drawerSurface.withValues(alpha: 0.95),
              ...
              children: [
                if (leading != null) ...[
                  Container(
                    ...
                    height: 48,
                    decoration: BoxDecoration(
                      color: (iconColor ?? AppTheme.accentCyan).withValues(alpha: 0.2),
